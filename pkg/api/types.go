...
type KubernetesConfig struct {
	...
	ExistingUserAssignedIdentityProfile *ExistingUserAssignedIdentityProfile `json:"existUserAssignedIdentityProfile,omitempty"`
...
type ExistingUserAssignedIdentityProfile struct {
...
func (k *KubernetesConfig) UserAssignedIDEnabled() bool {
	return k.UseManagedIdentity && (k.UserAssignedID != "" || k.ExistingUserAssignedIdentityProfile != nil)
}
