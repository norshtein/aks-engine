...
func CreateCustomScriptExtension(cs *api.ContainerService) VirtualMachineExtensionARM {
	...
	var existingIdentityClientID string
	if cs.Properties.OrchestratorProfile != nil && cs.Properties.OrchestratorProfile.KubernetesConfig != nil && cs.Properties.OrchestratorProfile.KubernetesConfig.ExistingUserAssignedIdentityProfile != nil {
